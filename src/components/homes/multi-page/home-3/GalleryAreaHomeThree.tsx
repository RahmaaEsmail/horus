...
const GalleryAreaHomeThree = () => {
  return (
    <> 
      <div id="gallery-one-page" className="tp-gallery-area pt-50 pb-90">
        <div className="container-fluid">
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-gallery-title-box text-center mb-60">
                <span className="tp-section-subtitle tp-split-text tp-split-in-right">Latest Gallery</span>
                <h3 className="tp-section-title tp-split-text tp-split-in-right">Inspiring Interiors Exceptional <br /> Of Experiences</h3>
              </div>
            </div>
            <div className="col-xl-12">
