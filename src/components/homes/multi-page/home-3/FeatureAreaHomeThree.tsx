...
const feature_content: DataType = {
  ...
  feature_data: [
    ...
    },
    {
      ...
      icon: `<svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M40.6955 60.2004C40.8936 60.3985 41.1536 60.498 41.4136 60.498C41.6736 60.498 41.9336 60.3985 42.1316 60.2004L43.7231 58.6089C44.1202 58.2118 44.1202 57.5699 43.7231 57.1728C43.326 56.7757 42.6841 56.7757 42.287 57.1728L40.6955 58.7643C40.2994 59.1614 40.2994 59.8043 40.6955 60.2004Z" fill="currentcolor" /> </svg>`
    },
    {
      title: 'Consultation',
      description: 'Professional consultation services to help you make informed decisions about your space transformation.',
      icon: `<svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M26.4062 18.2812C26.9672 18.2812 27.4219 17.8265 27.4219 17.2656C27.4219 16.7047 26.9672 16.25 26.4062 16.25C25.8453 16.25 25.3906 16.7047 25.3906 17.2656C25.3906 17.8265 25.8453 18.2812 26.4062 18.2812Z" fill="currentcolor" /> </svg>`
    }
  ]
}
