...
const testimonial_content: DataType = {
  ...
  title: `Discover the Art Interior Transformation`,
  description: `loborti viverra laoreet matti ullamcorper posuere viverra Aliquam eros justo, posuere lobortis non, Aliquam eros justo, posuere loborti viverra laorematullamcorpeposuere viverra`,
}
