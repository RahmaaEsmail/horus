  ...
  return (
    <Modal open={open} onCancel={() => setOpen(false)} footer={null} width={800}>
      <div className='main_img_container'>
        <Image
          className='main-img'
          src={images[currentIndex] ||  images[currentIndex]?.img}
          width={700}
          height={400}
          alt="Main View"
        />
        <div className='arrows'>
          <div onClick={handlePrevImg} className='left-arrow'><HiChevronLeft /></div>
          <div onClick={handleNextImg} className='right-arrow'><HiChevronRight /></div>
        </div>
      </div>
